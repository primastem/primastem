...
В центр робота можно установить маркет диаметром менее 10 мм. для возможности рисования простых геометрических фигур во время движения.
...
На пульте управления 2 кнопки: слева расположена кнопка включения, справа кнопка “Выполнить / Остановить” для передачи программы игровому роботу и остановки программы в процессе выполнения.

После установки фишек команд и значений в ячейки пульта необходимо нажать кнопку “Выполнить” и робот начнет выполнять программу. Выполнение текущих команд подсвечивается многоцветными светодиодами расположенными между ячейками для установки фишек команд и значений.
...
- После обновления ПО устройства возможно потребуется калибровка гироскопа и длинны движения "по умолчанию" для робота: 
...
Аккумуляторы следует заряжать или за 1-2 часа до урока, или после урока. Заряда пульта и робота по 1 часу обычно хватает на 1-2 урока, полного заряда (в течении 2-3 часов) хватает на 3 урока по 30-45 минут. Емкость и время работы аккумуляторов со временем может упасть. Возможна замена на новые стандарта 16340 Li-ion.
